...
$shopid = $_GET['id'];
$sql = "SELECT * FROM deposits WHERE userid = '$shopid'";
...
while ($fetch = mysqli_fetch_array($query)) {?>
                                            <tr class="tr-shadow">
                                                ...
                                                <td> <span class="block-email"><?php echo $fetch['email']; ?></span>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a href="editHistory.php?id=<?php echo $fetch['id']; ?>"
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <a href="delHistory.php?id=<?php echo $fetch['id']; ?>"
                                                            class="item" data-toggle="tooltip" data-placement="top"
                                                            title="Delete">
