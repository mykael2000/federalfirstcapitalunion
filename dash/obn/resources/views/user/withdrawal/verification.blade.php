...
@section('title', 'OBNK - Withdrawal - Verification')
        ...
        <div class="col-md-8 offset-md-2 mt-4">
            <div class="card">
                <div class="card-header">                               
                    <h4 class="card-title">Withdrawal verification</h4>                                
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <div class="row">                                           
                            <div class="col-12">
                                <form autocomplete="OFF" method="post" action="{{ route('user.withdrawal.verify') }}">
                                    @csrf
