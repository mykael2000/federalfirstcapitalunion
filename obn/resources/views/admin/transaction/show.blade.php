...
<div class="contentbar">
    ...
    <div class="row">
		...
		<div class="col-12 mt-1 alert alert-success">{{ $success }}</div>
		@endif
                        ...
                        <table id="example" class="display table dataTable table-bordered" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="text-info">{{$transaction->status}}</span></td>
                                    <td>{{ date('d/m/Y', strtotime($transaction->created_at)) }}</td>
									<td><a href="{{ route('admin.transactions.deleteTrans', $transaction->id) }}" class="btn btn-sm btn-danger">Delete</a></td>
                                </tr>
