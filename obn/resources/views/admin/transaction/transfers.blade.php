    ...
    <div class="row ">
        <div class="col-12  align-self-center">
            <div class="sub-header mt-3 py-3 px-3 align-self-center d-sm-flex w-100 rounded">
                <div class="w-sm-100 mr-auto"><h4 class="mb-0">Transfer Transactions</h4></div>
                <a href="{{ route('admin.transactions.withdrawals') }}" class="btn btn-success text-white">View Withdrawal Transactions</a>
            </div>
        </div>
    </div>
    <!-- END: Breadcrumbs-->
                        ...
                        <table id="example" class="display table dataTable table-striped table-bordered" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.transactions.edit-transfer', $transaction->id) }}" class="btn btn-primary btn-sm">Edit</a>
                                        <a href="{{ route('admin.transactions.delete-transfer', $transaction->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
