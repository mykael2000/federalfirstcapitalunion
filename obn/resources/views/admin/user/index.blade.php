...
<div class="breadcrumbbar">
    <div class="row align-items-center">
        ...
        <div class="col-md-4 col-lg-4">
            <div class="widgetbar">
                <a href="{{ route('admin.users.create') }}" class="btn btn-primary-rgba"><i class="feather icon-user-plus mr-2"></i>Add user</a>
            </div>                        
        </div>
    </div>          
</div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.users.delete', $user->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                        <a href="{{ route('admin.users.login-as', $user->id) }}" class="btn btn-success btn-sm mt-1 form-control" style="background-color:#44bd32;color:#fff;">Login As</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
